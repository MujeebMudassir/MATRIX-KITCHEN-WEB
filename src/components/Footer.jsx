        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-sm">123 Kitchen Street, Cookware City, CC 12345</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="text-sm">support@bartann.com</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:text-white transition-colors">Warranty Information</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm hover:text-white transition-colors">Track Your Order</a></li>
              <li><a href="#" className="text-sm hover:text-white transition-colors">Wishlist</a></li>
              <li><a href="#" className="text-sm hover:text-white transition-colors">Product Care</a></li>
          ...
          <div>
            ...
            <p className="text-xs mt-4 text-gray-400">By subscribing you agree to receive marketing emails from BARTANN.</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400 mb-4 md:mb-0">
              © 2025 BARTANN. All rights reserved.
            </p>
